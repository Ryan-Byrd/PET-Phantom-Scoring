# __init__.py for local pylinac compatibility
import os, sys

# Define a fake version so relative imports like `from .. import __version__` succeed
__version__ = "3.6-local"

# Ensure subpackages are importable when run outside installed pylinac
_here = os.path.dirname(os.path.abspath(__file__))
for subdir in ["core", "ct"]:
